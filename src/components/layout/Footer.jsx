 ...
 *
 * Il reste donc : qui édite, où trouver les liens, et les mentions légales.
 *
...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-cream/10 bg-bark text-cream">
      <div className="mx-auto flex w-full max-w-page flex-wrap items-center justify-between gap-x-8 gap-y-4 px-5 pb-[calc(66px+1rem)] pt-5 sm:px-8 lg:px-12 lg:pb-6 lg:pt-6">
